...
public class Utils {
    ...
    public static void sendActionSuccess(String actionName, CallbackContext callbackContext) {
        try {
    ...
    public static void sendActionError(String actionName, String error, CallbackContext callbackContext) {
        try {
            JSONObject response = new JSONObject();
            response.put("action", actionName);
